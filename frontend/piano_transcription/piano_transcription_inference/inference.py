...
class PianoTranscription(object):
    def __init__(self, model_type='Note_pedal',
        ...
        checkpoint_path="./piano_transcription_inference_data/note_F1=0.9677_pedal_F1=0.9186.pth"
        ...
        if 'cuda' in str(device):
            ...
            print('GPU 数量: {}'.format(torch.cuda.device_count()))
    ...
    def transcribe(self, audio, midi_path):
        ...
        if midi_path:
            ...
            print('处理完成, 导出路径为: {}'.format(midi_path))
